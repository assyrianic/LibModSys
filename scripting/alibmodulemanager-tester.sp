...
public void OnMapStart() {
	...
	PrintToServer("LibModuleManagerTester GlobalFwd :: exec_type: '%i' - param_count: '%i'", fwd_example.exec_type, fwd_example.param_count);
	...
	PrintToServer("LibModuleManagerTester PrivateFwd :: exec_type: '%i' - param_count: '%i' - function count: '%i'", pf.exec_type, pf.param_count, pf.Count());
